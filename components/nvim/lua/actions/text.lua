...
-- 删除Python注释和文档字符串（暂禁用：原 useful_scripts/remove_comments.py 已迁移，新路径未确认）
local function remove_python_comments_and_docstrings()
	vim.notify("remove_python_comments_and_docstrings 暂禁用", vim.log.levels.WARN)
	-- vim.api.nvim_buf_set_lines(buf, 0, -1, false, new_lines)
	-- vim.notify("已删除Python注释和文档字符串", vim.log.levels.INFO)
end
-- 行编号函数
function M.number_lines()
