...
page=(ROOT/"site/index.template.html").read_text().replace("__VERSION__",version).replace("__CHAPTER2__",str(meta["chapters"][1]["start"])).replace("__CHAPTER3__",str(meta["chapters"][2]["start"])).replace("__MEDIA_VERSION__",meta["version"])
